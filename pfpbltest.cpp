		...
		case 1:
		{
			...
			while (true)
			{
				while (true)
				{
					...
					cin >> entries;
					if ((entries % 1) != 0) //  greater than or equals to 1
					{
		...
		case 2:
		{
			...
			while (true)
			{
				...
				while (true)
				{
					...
					cin >> inclase;
					if (!(inclase == "A" || inclase == "B" || inclase == "C" || inclase == "D"))
					{
						system("cls");
						cout << "Enter a valid option ";
						continue;
		...
		case 3:
		{
			while (true)
			{
				...
				while (true)
				{
					...
					cin >> chkclas;
					if (!(chkclas == "A" || chkclas == "B" || chkclas == "C" || chkclas == "D"))
					{
						system("cls");
						cout << "Enter a valid option. ";
						continue;
